...
export interface Episode {
  ...
  title: string;
  /**
   * Add the Simplecast player for this episode
   */
...
export interface SimplecastEmbedBlock {
  /**
   * Enter the Simplecast episode ID (e.g., 98708a39-37d7-4cf1-ab1c-a17cae6bdd75)
   */
  episodeId: string;
  /**
  ...
  height?: number | null;
  /**
   * Enable dark mode for the player
   */
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        simplecastEmbed?: T | SimplecastEmbedBlockSelect<T>;
      };
  meta?:
    | T
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SimplecastEmbedBlock_select".
 */
export interface SimplecastEmbedBlockSelect<T extends boolean = true> {
  episodeId?: T;
  height?: T;
  darkMode?: T;
  id?: T;
